...
<head>
    ...
    <title>Login - PetTracker GPS</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <style>
        body { background: radial-gradient(circle at top right, #eef2ff, #ffffff); min-height: 100vh; }
    </style>
</head>
    ...
    <div class="w-full max-w-md">
        <div class="flex justify-center mb-6">
            <div class="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex items-center justify-center">
                <img src="{{ asset('imagenes/splash.png') }}" alt="Logo" class="h-16 w-auto">
            </div>
        </div>

        <div class="bg-white/80 backdrop-blur-md p-8 rounded-3xl shadow-2xl border-2 border-[#e65100] w-full">
            <div class="text-center mb-8">
                <h2 class="text-2xl font-black text-slate-800 tracking-tight uppercase">Bienvenido de nuevo</h2>
                <p class="text-slate-500 text-sm mt-1">Ingresa para localizar a tu mascota</p>
            </div>
            ...
            <div class="mt-8 pt-6 border-t border-slate-100 text-center">
                <p class="text-sm text-slate-600 font-medium uppercase">
                    ¿No tienes cuenta? 
                    <a href="{{ route('registro.index') }}" class="text-[#0a112c] font-bold hover:text-[#e65100] transition-colors">REGÍSTRATE AQUÍ</a>
                </p>
            </div>
        </div>
    </div>
